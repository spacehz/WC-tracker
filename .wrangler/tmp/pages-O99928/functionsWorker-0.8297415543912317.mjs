...
var broadcasters_default = {
  _README: "THIS FILE IS YOURS TO EDIT. 'name'/'nameAr' = channel name, 'flag' emoji, 'type' tv|stream, 'free' true=free-to-air, 'url' = official site. Per-match VIDEOS are configured separately in data/match-embeds.json (keyed by match id).",
  defaultCountry: "TN",
  countries: {
    TN: {
      name: "Tunisia",
...
// ../.wrangler/tmp/pages-O99928/functionsRoutes-0.46777716169025707.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-b7NIBz/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-b7NIBz/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8297415543912317.mjs.map
